    ...
    $productid=$row['productid'];
      ...
      $queryy= "SELECT * FROM product WHERE id='$productid'";
       ...
       echo '<li class="clearfix">';
           echo '<img src="data:image/png;base64,'.base64_encode($roww['image']).' "height=20" width="20" />';
...
<form  name="login" id="contact" action="loggedin.php" method="POST">
...
<center><input type="submit"   value="Login" class="btn btn-primary" style="margin-top: 20px;width: 140px; border-radius: 5%"/></center></form>
<br/>

</div>

<div class="col-lg-3 col-lg-offset-2" id="contactdiv">
...
<br/>
<input type="text" id="name"  placeholder="Name" required="" name="name"  /><br/>
<br/>
<label>Email: <span style="color: red">*</span></label>
<br/>
<input type="text" id="emaill"  placeholder="Email" name="emaill" required=""  /><br/>
<br/>
<label>Password: <span style="color: red">*</span></label>
<br/>
<input type="password" id="passwordd"  placeholder="Password" name="passwordd" required=""  /><br/>
<br/>
<label>Contact No: <span style="color: red">*</span></label>
<br/>
<input type="text" id="phone" placeholder="" name="phone" required="" /><br/>
<br/>
...
<br/>
<input type="text" id="postalcode"  placeholder="Postal Code" name="postalcode" required=""  /><br/>
<br/>
...
<br/>
<input type="text" id="country"  placeholder="Country" name="country" required=""  /><br/>
<br/>

<center><button type="submit" id="sendd"  class="btn btn-primary" style="margin-top: 20px;width: 140px; border-radius: 5%">Register</button></center></form>
<br/>


</div>
<center><p id="centerr" style="color: red; font-size: 12px; display: none"> You have successfully registered</p></center>
</div>
</div>
