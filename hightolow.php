			                    ...
			                    <div class="main-menu f-right">
			                        <nav>
			                            <ul>
                                          ...
                                          <li id="mine" class="mega-position"><a href="#">Shop</a>
                            ...
                            <nav id="dropdown">
                                <ul>
                                    <li><a class="active1" href="loginsuccess.php">Home</a>
                                     ...
                                     <li  class="mega-position"><a id="mine" href="">Shop</a>
...
<?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
			if($i == 1):?>
            <li class='active'  id="<?php echo $i;?>"><a href='pagination1.php?page=<?php echo $i;?>'><?php echo $i;?></a></li> 
			<?php else:?>
			<li id="<?php echo $i;?>"><a href='pagination1.php?page=<?php echo $i;?>'><?php echo $i;?></a></li>
		<?php endif;?>			
<?php endfor;endif;?>  
</div>
...
jQuery("#target-content").load("pagination1.php?page=1");
    jQuery("#pagination1 li").live('click',function(e){
	e.preventDefault();
		
		jQuery("#pagination1 li").removeClass('active');
		jQuery(this).addClass('active');
        var pageNum = this.id;
        jQuery("#target-content").load("pagination1.php?page=" + pageNum);
    });
    });
</script>
<?php
...
{
$limit= 9;
$sql = "SELECT COUNT(id) FROM product WHERE category='Men' ";  
$rs_result = mysqli_query($conn,$sql);  
$row = mysqli_fetch_row($rs_result);  
$total_records = $row[0];  
...
?>
<div align="center">
<ul class='pagination text-center ' id="pagination4">
<?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
            if($i == 1):?>
...
jQuery("#target-content").load("pagination4.php?page=1");
    jQuery("#pagination4 li").live('click',function(e){
    e.preventDefault();
        
        jQuery("#pagination4 li").removeClass('active');
        jQuery(this).addClass('active');
        var pageNum = this.id;
...
<script type="text/javascript">
    $('#me').on('click', function () {
      ...
      window.location.href="men.php";
        ...
        <script type="text/javascript" charset="utf8" src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.2.min.js"></script>
<!-- Mirrored from nahartheme.com/tf/kinley-preview/shop-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jun 2018 07:11:41 GMT -->
</html>
