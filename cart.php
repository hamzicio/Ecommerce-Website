...
?>        
        ...
        $price=$_SESSION["price"];
          ...
          if(mysqli_num_rows($check) > 0)
          {
            ...
            $sql2= "UPDATE cart SET totalprice='$tprice' WHERE  productid='$productid' AND userid='$userid'";
            $checkk=mysqli_query($conn,$sql);
            $checkk1=mysqli_query($conn,$sql2);
        ...
        $sql = "INSERT INTO cart (userid, productid,quantity,totalprice) VALUES ('$userid', '$productid','$quantity','$tprice')";
        $shaikh=mysqli_query($conn, $sql);
