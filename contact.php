                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-lg-7 col-sm-7">
                                <div class="sent-message">
                                    <form class="contact_form" id="contact_form" action="#"  name="formm" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <button class="submit ripple-btn" type="submit" name="submit" id="show" data-complete-text="Well done!">Send Message</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    $('#mine').on('click', function () {
        ...
        <script>
            ...
            function initialize()
            {
                ...
                var map=new google.maps.Map(document.getElementById("kinley"),mapProp);
